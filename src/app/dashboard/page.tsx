  ...
  if (!data?.summary) {
    return (
      <Shell
        ...
        docPages={419}
      >
        <EmptyBlock label="No dashboard summary available." />
      </Shell>
    );
  }
    ...
    >
      <div className="space-y-6">
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
          <div className="glass-panel rounded-[28px] border border-white/10 p-6 lg:p-7">
            ...
            <p className="page-subtitle">
              Live operational view of SEBI compliance activity across circular
              ingestion, obligation discovery, workflow progress, and
              department posture.
            </p>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          <KpiCard
            title="New Circulars this month"
            value={s.new_circulars_this_month}
          />

          <KpiCard
            title="Obligations found"
            value={s.obligations_found}
          />

          <KpiCard
            title="High Critical"
            value={s.high_critical_obligations}
          />
